...
**Date:** 2026-05-02
**Mockups (truth):**
- `docs/mockups/research-history.html` — Landing + History
- `docs/mockups/research-activity.html` — Activity tab (events+telemetry+reviews) — **Variant A only, refinements applied** ✓
- `docs/mockups/research-graph.html` — Graph tab (knowledge+process) — **Variant E only, ultrawide-tuned** ✓
...
- **Tasks:**
  ...
  - Update `docs/specs/RESEARCH.md` to reflect the new tab list and the renamed history route
...
- [ ] `docs/specs/RESEARCH.md` reflects the new tabs and routes.
