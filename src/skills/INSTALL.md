...
- SKILL.md files exist: `address`, `agent-browser`, `agent-review`, `code-debug`, `code-review`, `context-compact`, `design-construct`, `design-review`, `docs-optimize`, `docs-review`, `dogfood`, `eval-harness`, `git-workflow`, `interview`, `omnibus`, `ralph-loop`, `red-team`, `search`, `security-review`, `skill-creator`, `test-webapp`
