...
- SKILL.md files exist: `address`, `agent-browser`, `agent-review`, `code-review`, `context-compact`, `debug`, `design-review`, `docs-review`, `dogfood`, `git`, `interview`, `omnibus`, `ralph-loop`, `red-team`, `search`, `skill-creator`, `test-webapp`
