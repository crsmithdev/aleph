...
- SKILL.md files exist: `address`, `agent-review`, `code-review`, `code-test`, `context-compact`, `debug`, `design-review`, `docs-review`, `dogfood`, `git`, `interview`, `omnibus`, `ralph-loop`, `red-team`, `search`, `skill-creator`
