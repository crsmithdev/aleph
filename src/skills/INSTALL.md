...
- SKILL.md files exist: `brainstorming`, `tdd`, `writing-plans`, `executing-plans`, `debugging`, `verification`, `subagent-dev`, `parallel-agents`, `finishing-branch`, `git-worktrees`, `code-review`, `docs-review`, `commands-review`, `config-review`, `hooks-review`, `skills-review`, `research`, `ralph-loop`
