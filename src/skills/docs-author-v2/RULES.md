...
Cross-referenced by:
- `docs-author-v2/SKILL.md` — applies these rules silently during generation
- `docs-audit/SKILL.md` — checks existing docs against these rules
- `docs-conform/SKILL.md` — uses these rules to validate alignment
