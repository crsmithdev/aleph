          ...
          {envCheck.jina_balance !== null && (
            <div className="rounded border border-border-primary bg-bg-secondary px-3 py-2 flex items-center gap-2">
              ...
              {(envCheck.jina_paid_balance ?? 0) > 0 ? (
                <>
                  <span className={clsx('text-xs font-medium tabular-nums', envCheck.jina_paid_balance! < 100_000 ? 'text-red-400' : envCheck.jina_paid_balance! < 1_000_000 ? 'text-yellow-400' : 'text-green-400')}>
